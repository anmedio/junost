...
const computerScienceTag = {
  tag: 'Computer science (basics)',
  name: 'Computer science (basics)',
  text:
    'Основы программирования и Computer Science - это те самые фундаментальные знания, которые необходимы каждому, кто хочет стать настоящим инженером, ведь нужно не просто знать, как писать код, но и понимать, как  этот код работает сейчас и будет работать при других условиях.',
  links: [
    {
      url: 'https://habr.com/ru/company/vertdider/blog/403823/',
      name: 'Легендарный гарвардский курс CS50',
    },
    {
      url:
...
const figmaAdobeXDTag = {
  ...
  links: [
    ...
    {
      url: 'https://coursehunters.net/course/adobe-xd-uskorennyy-kurs',
      name: 'Курс "Adobe XD Crash Course"',
    },
  ],
};

const javascriptBasicsTag = {
...
const bootstrapTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'Academind - "Bootstrap 4 Concepts & Setup | BOOTSTRAP 4 TUTORIAL"',
    },
    {
...
const es6Tag = {
  ...
  links: [
    ...
    {
      url: 'https://www.youtube.com/channel/UCEBHlT_L1ME6e9ixaRPp0wg/videos',
...
const eslintTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'Wes Bos - "ESLint + Prettier + VS Code — The Perfect Setup"',
    },
    {
      url: 'https://www.youtube.com/watch?v=5zIRX5k9mg4',
      name: 'Для тех, кто любит необычную подачу информации ;D - Jilio',
    },
    {
...
const makefileTag = {
  ...
  links: [
    ...
    {
      url:
        'https://github.com/inem/make-handbook/blob/master/modern-make-handbook-ru.md',
...
const canvasTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'WebDev с нуля. Канал Алекса Лущенко - "JavaScript Canvas"',
    },
  ],
};
...
const regularExpressionsTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'CodeSchool - "Breaking the ice with Regulae Expressions"',
    },
    {
...
const optimizationTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'Полезные проекты и инструменты для работы с Chrome DevTools',
    },
    {
...
const designPrincipleTag = {
  // TODO: Добавить материал
  tag: 'DRY / KISS / YAGNI / SOLID',
  name: 'DRY / KISS / YAGNI / SOLID',
  text: 'Ключевые принципы разработки ПО, которые Вы должны понимать!',
  links: [
    {
...
const javascriptAdvancedTag = {
  ...
  links: [
    ...
    {
      url: 'https://coursehunters.net/course/prodvinutye-koncepcii-javascript',
...
const typescriptTag = {
  ...
  links: [
    ...
    {
      url: 'https://coursehunters.net/course/itvdn-typescript-fundamentals',
      name: 'ITVDN - "TypeScript Fundamentals"',
    },
    {
      url: 'https://coursehunters.net/course/understanding-typescript',
...
const nuxtJsTag = {
  ...
  links: [
    ...
    },
    {
      url:
        'https://www.youtube.com/playlist?list=PL55RiY5tL51pk1RvaQOxI6sJ-yZzExzJn',
      name: 'Academind - "Nuxt.js & Storyblok - Building a Complete Blog"',
    },
  ],
};
const pwaTag = {
...
const graphQLTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'freeCodeCamp.org - "GraphQL Full Course - Novice to Expert"',
    },
    {
      url:
...
const firebaseTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'Academind - "FULL PROJECT with Vue.js + Vuetify + Firebase"',
    },
  ],
};

const nodeJsBasicsTag = {
  tag: 'Nodejs (basics)',
  name: 'Nodejs (basics)',
  text:
...
const oopTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'Книга Мэтта Вайсфельда - "Объектно-ориентированное мышление"',
    },
    {
  ...
  links: [
    {
      ...
      name: 'Статья на Habr - "Паттерны для новичков: MVC vs MVP vs MVVM"',
    },
    {
...
const functionalProgrammingTag = {
  ...
  links: [
    {
      ...
      name: 'Презентация по введению в функциональное программирование',
    },
    {
      url:
...
const sslTag = {
  ...
  links: [
    {
      url: 'https://mnorin.com/tls-ssl-neobhodimy-j-minimum-znanij.html',
  ...
  links: [
    {
      ...
      name: 'Статья на Medium - "Сравнение SOAP и REST с JSON [2019]"',
    },
    {
...
const tddTag = {
  ...
  links: [
    ...
    {
      url: 'https://medium.com/@ryuta_udo/tdd-bdd-with-javascript-3dde511e4e2f',
      name: 'Статья на Medium - "TDD / BDD with JavaScript"',
    },
  ],
};

const algorithmAnalysisAndDesignTag = {
...
const dataStructuresRealisationTag = {
...
const networkAdvancedTag = {
  ...
  links: [
    ...
    {
      url: 'http://www.ipa.nw.ru/PAGE/aspirantura/literatura/tanenbaum.pdf',
      name: 'Книга Э. Таненбаум, Д. Уэзеролл -  "Компьютерные сети"',
    },
    {
      url: 'https://proglib.io/p/networks-course/',
      name: 'Курс на ProgLib - "Лучший видеокурс по сетевым технологиям"',
    },
  ],
};

const databasesBasicsTag =
  // TODO: Добавить материалы
  {
...
const electronTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'Traversy Media - "Build an Electron App in Under 60 Minutes"',
    },
    {
...
const nodeJsAdvancedTag = {
  tag: 'Nodejs (advanced)',
  name: 'Nodejs (advanced)',
  text: 'Продвинутый уровень Nodejs для продвинутых разработчиков. Дерзайте!',
  links: [
    {
      url:
...
const loopback4Tag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'StrongLoop Videos - "LoopBack 4 Demo Example todo application"',
    },
  ],
};
const nestJsTag = {
...
const redisTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'Redis Labs - "Building Light weight Microservices Using Redis"',
    },
    {
      url:
...
const microservicesArchitectureTag = {
  // TODO: Добавить материалы
...
const libuvAndAsynchronousIOTag = {
...
const elasticSearchTag = {
  ...
  links: [
    ...
    },
    {
      ...
      name: 'Programming With Spirit - "Use Elasticsearch in Node.js App"',
    },
  ],
};
